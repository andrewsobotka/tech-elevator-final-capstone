...
INSERT INTO recipes (creator_id, title, description, serving_size) VALUES ((SELECT user_id FROM users WHERE username = 'user' LIMIT 1), 'Cheese Pizza', E'Cheese, Sauce, and Crust. It\'s always good. Make it.', 10);
