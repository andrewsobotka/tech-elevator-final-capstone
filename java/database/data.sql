...
INSERT INTO recipes (creator_id, recipe_name, image_url, description, serving_size) VALUES ((SELECT user_id FROM users WHERE username = 'user' LIMIT 1), 'Cheese Pizza', 'https://images.unsplash.com/photo-1639744210916-74793fdd9a88?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1336&q=80', E'Cheese, Sauce, and Crust. It\'s always good. Make it.', 10);
INSERT INTO recipes (creator_id, recipe_name, image_url, description, serving_size) VALUES ((SELECT user_id FROM users WHERE username = 'admin' LIMIT 1), 'Sourdough Bread', 'https://images.unsplash.com/photo-1620921586333-b7566c34550a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1335&q=80', E'It\'s not actually sour, but it is bread.', 6);
INSERT INTO recipes (creator_id, recipe_name, image_url, description, serving_size) VALUES ((SELECT user_id FROM users WHERE username = 'user' LIMIT 1), 'Spaghetti', 'https://images.unsplash.com/photo-1627286400579-027de47e9e73?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1287&q=80', 'Delicious red tomato sauce and amazing spaghetti.', 2);
